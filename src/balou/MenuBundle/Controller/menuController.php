...
use balou\MenuBundle\Form\menuType;
...
class menuController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('balouMenuBundle:menu')->findAll();
     ...
     * @Method("POST")
     * @Template("balouMenuBundle:menu:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('balouMenuBundle:menu')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("balouMenuBundle:menu:edit.html.twig")
     */

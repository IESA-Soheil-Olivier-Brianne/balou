...
use balou\PageBundle\Form\ArticlesType;
...
class ArticlesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('balouPageBundle:Articles')->findAll();
     ...
     *
     * @Route("/", name="admin_articles_create")
     * @Method("POST")
     * @Template("balouPageBundle:Articles:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('balouPageBundle:Articles')->find($id);
    ...
    */
     ...
     *
     * @Route("/{id}", name="admin_articles_update")
     * @Method("PUT")
     * @Template("balouPageBundle:Articles:edit.html.twig")
     */
     ...
     *
     * @Route("/{id}", name="admin_articles_delete")
     * @Method("DELETE")
     */

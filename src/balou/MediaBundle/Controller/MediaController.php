...
use balou\MediaBundle\Form\MediaType;
...
class MediaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('balouMediaBundle:Media')->findAll();
     ...
     * @Method("POST")
     * @Template("balouMediaBundle:Media:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('balouMediaBundle:Media')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("balouMediaBundle:Media:edit.html.twig")
     */
